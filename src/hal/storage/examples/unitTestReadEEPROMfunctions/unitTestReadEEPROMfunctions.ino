...
void setup()
{
	...
	hal_storage_read_end(HAL_STORAGE_ID_PRIVATE_KEY, (void *) value_PRIVATE_KEY_out, sizeof(value_PRIVATE_KEY_out));

	hal_storage_read_end(HAL_STORAGE_ID_PUBLIC_KEY, (void *) value_PUBLIC_KEY_out, sizeof(value_PUBLIC_KEY_out));

	hal_storage_read_end(HAL_STORAGE_ID_FOREIGN_KEY, (void *) value_FOREIGN_KEY_out, sizeof(value_FOREIGN_KEY_out));
