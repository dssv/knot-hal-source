...
char value_UUID[UUID_SIZE] = "G43J-1I2J-76JI-M5N6-9N8M-12J3-54HU-";
char value_UUID_out[UUID_SIZE+1];
char value_TOKEN[TOKEN_SIZE] = "1H2U-I34J-KO54-5N4J-0N9M-7N6J-65UH48987";
...
static uint8_t value_PUBLIC_KEY[PUBLIC_KEY_SIZE] = {
	0x1F, 0x37, 0x66, 0xC9, 0x8A, 0xDB, 0x2D, 0x0C, 0xAF, 0x8C, 0x02, 0xE4, 0x47,
	 0x05, 0x9C, 0xB0, 0xFE, 0x6F, 0x1A, 0x40, 0x3D, 0x57, 0x70, 0x0D, 0x9B, 0x3F,
	  0x34, 0xCD, 0xD4, 0xCF, 0xDC, 0x8C, 0x36, 0x6D, 0x48, 0x58, 0xAD, 0x64, 0xE5,
			0xE4, 0xAE, 0x9A, 0xC1, 0x49, 0xEF, 0xD9, 0x94, 0x75, 0xF8, 0x24, 0x7B, 0x9A,
				0xCF, 0x18, 0x53, 0xF9, 0x41, 0xB0, 0xC5, 0x5A, 0x86, 0xB9, 0x60, 0xF4
};
...
void setup()
{
	...
	hal_storage_write_end(HAL_STORAGE_ID_MAC, (void *) mac, sizeof(mac));
	hal_storage_write_end(HAL_STORAGE_ID_PRIVATE_KEY, (void *) value_PRIVATE_KEY,
		sizeof(value_PRIVATE_KEY));
	hal_storage_write_end(HAL_STORAGE_ID_PUBLIC_KEY, (void *) value_PUBLIC_KEY,
		sizeof(value_PRIVATE_KEY));
	...
	eeprom_read_block(&value_PRIVATE_KEY_out, (const void *) ADDR_PRIVATE_KEY, sizeof(value_PRIVATE_KEY));

	eeprom_read_block(&value_PUBLIC_KEY_out, (const void *) ADDR_PUBLIC_KEY, sizeof(value_PUBLIC_KEY));
